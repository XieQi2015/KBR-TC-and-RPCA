...
%   allfiles=dir('C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\hyperspectral image sequence\org\');
...
% allfiles=dir('C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\lemon_slices_ms\fake_and_real_lemon_slices_ms\');
% allfiles=dir('C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\glass_tiles_ms\glass_tiles_ms\');
% allfiles=dir('C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\beers_ms\fake_and_real_beers_ms\');
allfiles=dir('C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\balloons_ms\balloons_ms\');
path='C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\balloons_ms\balloons_ms\';
% path='C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\beers_ms\fake_and_real_beers_ms\';

% path='C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\glass_tiles_ms\glass_tiles_ms\';
% path='C:\Users\admin\Desktop\新建文件夹\TensorCompletion\data\mutilspectral\lemon_slices_ms\fake_and_real_lemon_slices_ms\';
